...
class Select extends \Magento\Framework\DB\Select
{
     ...
     * @param \Magento\Framework\DB\Adapter\Pdo\Mysql $mysqlAdapter
     * @param \Magento\Framework\DB\Select\SelectRenderer $selectRenderer
     * @param array $parts
     */
    public function __construct(
        AdapterInterface $adapter,
        \Magento\Framework\DB\Adapter\Pdo\Mysql $mysqlAdapter,
        \Magento\Framework\DB\Select\SelectRenderer $selectRenderer,
        $parts = []
    ) {
        parent::__construct($mysqlAdapter,$selectRenderer,$parts);
